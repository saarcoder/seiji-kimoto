<footer class="bg-light section pb-0">
  <div class="container">
      ...
      <div class="col-md-3 col-sm-6 mb-5">
        ...
        <ul class="list-inline social-icons">
          <li class="list-inline-item">
            <a href="https://www.facebook.com/jantcu/" aria-label="Facebook"
    ...
    <div class="border-top border-default text-center py-4 mt-4">
      <small class="content attribution"
        >Designed By <a href="https://themefisher.com/">Themefisher</a>
        Developed By <a href="https://jantcu.com/">Jantcu</a></small
      >
    </div>
  </div>
</footer>
