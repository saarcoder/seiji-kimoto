...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(strong0, "class", "svelte-1heygos");
			attr(li0, "class", "svelte-1heygos");
			attr(a, "href", a_href_value = "mailto:" + /*email*/ ctx[3]);
			attr(a, "class", "svelte-1heygos");
			attr(strong1, "class", "svelte-1heygos");
			attr(li1, "class", "svelte-1heygos");
			attr(strong2, "class", "svelte-1heygos");
			attr(li2, "class", "svelte-1heygos");
			attr(ul, "class", "svelte-1heygos");
			attr(div1, "class", "col-lg-5 content svelte-1heygos");
			attr(div2, "class", "row");
